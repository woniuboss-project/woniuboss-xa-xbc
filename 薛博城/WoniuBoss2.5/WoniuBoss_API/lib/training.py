...
class Tran:
    def __init__(self,sum):
        self.session = Service.get_session(sum)
    #搜索功能
    ...
    #废弃资源
    def Waste_resources(self,Waste_resources_url,Waste_resources_data):
        return self.session.post(Waste_resources_url,Waste_resources_data)
