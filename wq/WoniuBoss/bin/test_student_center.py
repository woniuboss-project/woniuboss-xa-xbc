...
#今日晨考数据
morning_datas=Utility.get_excel_to_tuple(student_center_datas[1])
#学员请假数据
vacate_datas=Utility.get_excel_to_tuple(student_center_datas[2])
#测评阶段数据
appraisal_datas=Utility.get_excel_to_tuple(student_center_datas[3])
#测试记录数据
record_datas=Utility.get_excel_to_tuple(student_center_datas[4])
#班级管理数据
class_datas=Utility.get_excel_to_tuple(student_center_datas[5])
