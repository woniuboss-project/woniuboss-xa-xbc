...
# 获取测试数据
from woniuboss2_ui.lib.report import Report
from woniuboss2_ui.tools.service import Service
from woniuboss2_ui.tools.utility import Utility

date_datas = Utility.get_json('../config/testdata_dengyu.conf')
...
class TestReport(unittest.TestCase):
    ...
    def test_console_query_four(self):
        ...
        result_four = Utility.query_one(path, sql_four)
    ...
    def test_console_query_five(self):
        ...
        result_five = Utility.query_one(path, sql_five)
